  ...
  return (
    <div className="py-12 bg-gray-900">
              ...
              <div key={course.id} className="flex justify-center">
                <BackgroundGradient className="flex flex-col rounded-[22px] bg-wihte dark:bg-zinc-900 overflow-hidden h-full max-w-sm">
                  <div className="p-4 sm:p-6 flex flex-col items-center text-center flex-grow">
                      ...
                      <Link className="border-2 rounded-md text-white px-4 py-2 mt-3" href={`/courses/${course.slug}`}>Learn More</Link>
                  </div>
                </BackgroundGradient>
              </div>
            ))}
      ...
      <div className="mt-20 text-center">
          <Link className="px-4 py-4 rounded border hover:border-2 border-neutral-600 text-neutral-700 hover:bg-transparent hover:border-neutral-200 hover:text-neutral-200 bg-white hover:bg-gray-100 transition duration-200" href={"/courses"}>
          View All Courses
          </Link>         
      </div>
    </div>
